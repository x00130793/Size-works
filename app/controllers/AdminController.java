...
public class AdminController extends Controller {
	...
	Form<Size> size = formFactory.form(Size.class);
        ...
        return ok(addProduct.render(addProductForm, getUserFromSession(), size));
    }
	...
	Form<Size> size = formFactory.form(Size.class).bindFromRequest();
        ...
        if(newProductForm.hasErrors()) {
            ...
            return badRequest(addProduct.render(newProductForm, getUserFromSession(), size));
        }
	...
	Size s = size.get();
		...
		s.setSizeName(size.get().getSizeName());
